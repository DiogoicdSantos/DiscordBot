...
client.on('message', message => {
    ...
    else if(command === 'cat'){client.commands.get('cat').execute(message, args);}
    ...
    else if(command === 'reaction'){client.commands.get('reaction').execute(message, args, Discord, client);}
});
